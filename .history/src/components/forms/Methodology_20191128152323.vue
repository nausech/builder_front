        ...
        <form action="POST" @submit.prevent="insertItem">
            <div class="grid row">
                <div class="flex md6 sm12">
                    <div class="grid row">
                        <label for="productList" class="flex md4 sm6 mt-2">Productos</label>
                        <div class="flex md8 sm6">
                            <va-select v-model="selectProduct" multiple textBy="nombre"
                            :options="productList" keyBy="nombre" />
                        </div>
                    </div>
                </div>
                <div class="flex md6 sm12">
                    <div class="grid row">
                        <label for="profileList" class="flex md6 sm12 mt-2">Intensidad de horas</label>
                        <div class="flex md6 sm12">
                            <va-select v-model="insert.horas" textBy="horas"
                            :options="profileList" id="profileList" :disabled="disabledSelected"/>
                        </div>
                    </div>
                </div>
                <div class="flex md4 sm12">
                    <div class="grid row">
                        <label for="minimo" class="flex md5 sm12 mt-2" style="text-align:center">Valor mínimo</label>
                        <div class="flex md7 sm12">
                            <va-input type="number" id="minimo" v-model="insert.minimo"/>
                        </div>
                    </div>
                </div>
                <div class="flex md4 sm12">
                    <div class="grid row">
                        <label for="maximo" class="flex md6 sm12 mt-2" style="text-align:center">Valor máximo:</label>
                        <div class="flex md6 sm12">
                            <va-input type="number" id="maximo" v-model="insert.maximo"/>
                        </div>
                    </div>
                </div>
                <div class="flex md4 sm12">
                    <div class="grid row">
                        <label for="valor" class="flex md5 sm12 mt-2" style="text-align:center">Valor a pagar</label>
                        <div class="flex md7 sm12">
                            <va-input type="number" id="valor" v-model="insert.valor"/>
                        </div>
                    </div>
                </div>
            </div>
            <!--//Button insert in table Methodology-->
            <div class="flex md12 align-right">
                <va-button color="info">{{ $t('Insertar fila') }}</va-button>
            </div>
        </form>
